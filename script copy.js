...
document.getElementById("paper_width").setAttribute("onkeyup", "custom_size(); paper_size(); process()");
document.getElementById("paper_height").setAttribute("onkeyup", "custom_size(); paper_size(); process()");
...
function color_table(a,b,c,d){
    if (a) {
        document.getElementById('potrait_row_col').classList.remove('bg-purple');
        document.getElementById('potrait_result').classList.remove('bg-purple');
        document.getElementById('potrait_qty').classList.remove('bg-purple');
    }

    if (b) {
        document.getElementById('landscape_row_col').classList.remove('bg-purple');
        document.getElementById('landscape_result').classList.remove('bg-purple');
        document.getElementById('landscape_qty').classList.remove('bg-purple');
    }

    if (c) {
        document.getElementById('potrait_row_col').className = 'bg-purple';
        document.getElementById('potrait_result').className = 'bg-purple';
        document.getElementById('potrait_qty').className = 'bg-purple';
    }
    
    if (d) {
        document.getElementById('landscape_row_col').className = 'bg-purple';
        document.getElementById('landscape_result').className = 'bg-purple';
        document.getElementById('landscape_qty').className = 'bg-purple';
    }
}
...
function change_name(){
    ...
    document.getElementById("potrait_file_size").innerHTML = "Ukuran File : "+print_width.value/10+"x"+print_height.value/10+" cm";
    document.getElementById("landscape_file_size").innerHTML = "Ukuran File : "+print_width.value/10+"x"+print_height.value/10+" cm";
}
...
function process(){
    ...
    if (potrait_result > landscape_result) {
        ...
        document.getElementById('base_potrait').classList.add('bg-purple');
        document.getElementById('base_landscape').classList.remove('bg-purple');

        shape_potrait = '';
        shape_landscape = 'bg-sec';
    }else if (potrait_result < landscape_result){
        color_table(true, true, false, true);
        document.getElementById('base_potrait').classList.remove('bg-purple');
        document.getElementById('base_landscape').classList.add('bg-purple');
    ...
    var dpt;
    (potrait_result > 1 || landscape_result > 1) ? (potrait_result >= landscape_result) ? dpt = "_(1d"+potrait_result+" = "+jlc+")" : dpt = "_(1d"+landscape_result+" = "+jlc+")" : dpt = "("+jlc+")";
    ...
    document.getElementById('nama_file').innerHTML = cst+jdl+bhn+" "+sde+dpt+fin+" TOTAL = "+bsr+" BESAR"+nota;
}
